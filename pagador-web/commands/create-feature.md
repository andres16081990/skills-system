...
```
SKILLS    = ~/skills/pagador-web/
FEATURES  = ~/skills/pagador-web/features/
CMDS      = ~/skills/pagador-web/commands/
COMPS     = ~/skills/pagador-web/components/
RULES     = ~/skills/pagador-web/GLOBAL_RULES.md
TEMPLATE  = ~/skills/pagador-web/features/FEATURE-SPEC-TEMPLATE.md
```
